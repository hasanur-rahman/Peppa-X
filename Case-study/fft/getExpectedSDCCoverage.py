...
exec_count_file = "profiling/exec-count/%s.txt"%prog_input.replace("-","").replace(" ", "_")

if ((not os.path.isfile(exec_count_file)) ):
        print("please provide inst")
        exit(1)
...
os.system("rm -rf profiling/exec-count/*")
## <START> Debug
