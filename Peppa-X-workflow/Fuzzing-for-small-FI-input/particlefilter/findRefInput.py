...
ranges = [[20,22], [20,22], [40,40], [70,75]]
limits = [40, 40, 40, 200]
increment_amount = [2, 2, 0, 5]
...
while cur_code_coverage < original_code_coverage  - 0.02:
	...
	inputArgStr = "-x %i -y %i -z %i -np %i"%(inputArg1, inputArg2, inputArg3, inputArg4)
