...
char inputArg1[40], inputArg2[40], inputArg3[40], inputArg4[40], inputArg5[40];
...
void calculateAndDumpResult()
{
	...
	char file_buffer[100];
        sprintf(file_buffer, "exec-count/%s_%s_%s_%s_%s.txt",inputArg1,  inputArg2, inputArg3, inputArg4, inputArg5);
...
//		fclose(f);
		...
		f = fopen("Input/cur_input.txt", "r");
                ...
                fscanf(f, "%s %s %s %s %s", inputArg1, inputArg2, inputArg3, inputArg4, inputArg5);
